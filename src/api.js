...
const lastMonth = `${currentYear}-${currentMonth - 1}-${currentDay}`;
...
const new_games = `/games?dates=${lastMonth},${currentDate}&ordering=-rating&page-size=15`;
...
export const searchGameURL = (game_name) =>
    `${base_url}/games?search=${game_name}&ordering=-rating&page_size=15`;
